...
type CreateGetters<Getters> = {
  [K in keyof Getters]: Getters[K] extends (...args: any[]) => infer Return ? Return : never
}

declare function defineStore<Id, State, Getters, Actions>(store: {
  id: Id,
  state(): State,
  getters: Getters & ThisType<Readonly<State & CreateGetters<Getters>>>,
  actions: Actions & ThisType<State & Readonly<CreateGetters<Getters>> & Actions>
}): Readonly<State & CreateGetters<Getters> & Actions>
